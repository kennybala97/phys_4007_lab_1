...
\subsection{ Description Of The Optical System }\label{subsec:description_of_the_optical_system}
...
\subsection{ Determining Phase Shift Between The Two Paths }\label{subsec:determining_phase_shift_between_the_two_paths}
...
\subsection{ Intensity Of The Interference Pattern As a Function of Path Length Difference }\label{subsec:intensity_of_the_interference_pattern_as_a_function_of_path_length_difference}
...
\subsection{ Observation of Fringes in the Interference Pattern }\label{subsec:observation_of_fringes_in_the_interference_pattern}
...
\subsection{ Dependence of Refractive Index on Temperature }\label{subsec:dependence_of_refractive_index_on_temperature}
...
\subsection{ General Setup }\label{subsec:general_setup}
...
\subsection{ Temperature Conversion Error Propagation }\label{subsec:temperature_conversion_error_propagation}
...
\subsection{ Theoretical Calculation of Refractive Index }\label{subsec:theoretical_calculation_of_refractive_index}
...
\subsection{ Error Propagation for Empirical Model Refractive Index }\label{subsec:error_propagation_for_empirical_model_refractive_index}
