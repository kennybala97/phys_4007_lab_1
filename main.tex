...
\subsection{Description Of The Optical System}
...
\subsection{Determining Phase Shift Between The Two Paths}
...
\subsection{Intensity Of The Interference Pattern As a Function of Path Length Difference}
...
\subsection{Observation of Fringes in the Interference Pattern}
...
\subsection{Dependence of Refractive Index on Temperature}
...
\subsection{Comparing Results to an Empirical Model of Refractive Index of Water vs. Temperature}
...
\subsection{General Setup}\label{subsec:exp_setup_general_setup}
...
\subsection{Setup for Path Length Difference Measurements}
The setup for this part of the experiment was identical to configuration mentioned in Section , but additionally
