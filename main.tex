...
\section{  Introduction }\label{sec:introduction }\label{sec:_introduction_}\label{sec:introduction}
...
\section{  Theory }\label{sec:theory }\label{sec:_theory_}\label{sec:theory}

\subsection{  Description Of The Optical System }\label{sec:description_of_the_optical_system }\label{subsec:_description_of_the_optical_system_}\label{sec:description_of_the_optical_system}
...
\subsection{  Observation of Fringes in the Interference Pattern }\label{sec:observation_of_fringes_in_the_interference_pattern }\label{subsec:_observation_of_fringes_in_the_interference_pattern_}\label{sec:observation_of_fringes_in_the_interference_pattern}
...
\subsection{  Setup for Path Length Difference Measurements }\label{sec:setup_for_path_length_difference_measurements }\label{subsec:_setup_for_path_length_difference_measurements_}\label{sec:setup_for_path_length_difference_measurements}
...
\subsection{  Temperature Conversion Error Propagation }\label{sec:temperature_conversion_error_propagation }\label{subsec:_temperature_conversion_error_propagation_}\label{sec:temperature_conversion_error_propagation}
...
\subsection{  Theoretical Calculation of Refractive Index }\label{sec:theoretical_calculation_of_refractive_index }\label{subsec:_theoretical_calculation_of_refractive_index_}\label{sec:theoretical_calculation_of_refractive_index}
...
\subsection{  Error Propagation for Empirical Model Refractive Index }\label{sec:error_propagation_for_empirical_model_refractive_index }\label{subsec:_error_propagation_for_empirical_model_refractive_index_}\label{sec:error_propagation_for_empirical_model_refractive_index}
